...
public class SupervisorActor extends BaseActor {
    ...
    protected void onInit(final Init obj) {
        ...
        registerActor(FileDispatcherActor.class, FileDispatcherActor.props(taskService, executor, service, 10), "FileDispatcherActor");
    ...
    // API
    public static Props props(final TaskService taskService, final TaskExecutor executor, final FileDispatcherService service) {
        return Props.create(SupervisorActor.class, () -> new SupervisorActor(taskService, executor, service));
    }
