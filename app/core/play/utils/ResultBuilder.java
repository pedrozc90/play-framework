...
public class ResultBuilder {
    ...
    public static StatusStep of() {
        return new Builder().of((Object) null);
    }
    ...
    private static class ResultMessage {
        ...
        public ResultMessage(final String message, final String error, final String stack, final Set<Violation> violations) {
